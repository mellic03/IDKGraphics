...
void idk::RenderEngine::RenderStage_deferred_geometry( idk::Camera &camera, float dtime )
{
    ...
    // -----------------------------------------------------------------------------------------
    {
        ...
        glShaderProgram &program = getProgram(RQ.name());
        program.bind();
    ...
    // -----------------------------------------------------------------------------------------
    {
        glShaderProgram &program = getProgram("gpass");
        program.bind();
    ...
    // Animated models
    // -----------------------------------------------------------------------------------------
    glShaderProgram &program_anim = getProgram("gpass-anim");
    program_anim.bind();
...
void idk::RenderEngine::RenderStage_deferred_lighting( idk::Camera &camera, float dtime )
{
    ...
    // Lighting pass
    // -----------------------------------------------------------------------------------------
    glShaderProgram &lighting = getProgram("lpass");
    lighting.bind();
