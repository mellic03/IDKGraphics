...
void
idk::drawmethods::bind_material( const std::string &name, glShaderProgram &program, Material &material )
{
...
void
idk::drawmethods::bind_material( glShaderProgram &program, Material &material )
{
...
void
idk::drawmethods::dummy( glShaderProgram &, int, const glm::mat4 &, ModelSystem & )
{
...
void
idk::drawmethods::draw_textured( glShaderProgram &program, int model_id,
...
idk::drawmethods::draw_animated( float dtime, glUBO &UBO, int animator_id, int model_id,
                                 glShaderProgram &program, glm::mat4 &model_mat, ModelSystem &MS )
{
...
void
idk::drawmethods::draw_untextured( glShaderProgram &program, int model_id,
...
void
idk::drawmethods::draw_indirect( glShaderProgram &program, int model_id,
                                 const glm::mat4 &transform, ModelSystem &MS )
{
    idk::Model &model = MS.getModel(model_id);
...
void
idk::drawmethods::draw_heightmapped( glShaderProgram &program, int model_id,
                                     const glm::mat4 &transform, ModelSystem &MS )
{
    idk::Model &model = MS.getModel(model_id);
